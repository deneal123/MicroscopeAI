...
def default_path():
    ...
    paths = {
        ...
        "path_to_detect_model": os.path.join(script_path, "weights", "weights_detect", "best_detect_3.pt"),
        "path_to_segment_model": os.path.join(script_path, "weights", "weights_seg", ".14"),
